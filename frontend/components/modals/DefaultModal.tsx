...
const DefaultModal = memo((props: Props) => {
    ...
    // Default snap points if none provided, but only if dynamic sizing is disabled
    const defaultSnapPoints = useMemo(() => ["80%"], []);
    const snapPoints = props.enableDynamicSizing ? undefined : (props.snapPoints || defaultSnapPoints);
    ...
    const styles = StyleSheet.create({
        contentContainer: {
            paddingHorizontal: props.customPadding ? 0 : 20,
