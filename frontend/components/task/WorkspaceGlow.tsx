    ...
    return (
        <View style={StyleSheet.absoluteFill} pointerEvents="none">
            <Svg width="100%" height="100%" viewBox="0 0 100 100" preserveAspectRatio="none">
                <Defs>
                    <RadialGradient id="wsGlowPurple" cx="50%" cy="50%" r="50%">
                        <Stop offset="0" stopColor={PURPLE} stopOpacity={peak.purple} />
                        <Stop offset="1" stopColor={PURPLE} stopOpacity="0" />
                    </RadialGradient>
                    <RadialGradient id="wsGlowBlue" cx="50%" cy="50%" r="50%">
                        <Stop offset="0" stopColor={BLUE} stopOpacity={peak.blue} />
                        <Stop offset="1" stopColor={BLUE} stopOpacity="0" />
                    </RadialGradient>
                </Defs>
                <Ellipse cx="30" cy="25" rx="38" ry="19" fill="url(#wsGlowPurple)" />
                <Ellipse cx="85" cy="80" rx="33" ry="16" fill="url(#wsGlowBlue)" />
            </Svg>
        </View>
    );
}
