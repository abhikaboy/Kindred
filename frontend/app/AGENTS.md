...
- `index.tsx` — auth gate; redirects to onboarding or login. Don't change without updating the auth flow.
...
- `(onboarding)/` — multi-screen onboarding; completion stored in AsyncStorage (`hasSeenOnboarding`).
