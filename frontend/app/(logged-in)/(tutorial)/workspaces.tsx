...
const WorkspacesTutorialScreen = (props: Props) => {
    ...
    const handleNext = () => {
        router.push('/(logged-in)/(tutorial)/categories');
    };
        ...
        <ThemedView style={styles.container}>
            ...
            >
                ...
                <View style={styles.videoContainer}>
                    <Video
                        source={require('@/assets/video/category.mp4')}
                        style={styles.video}
                ...
                <View style={styles.titleContainer}>
                    <ThemedText type="titleFraunces" style={styles.title}>
                        Workspaces have categories, which have tasks
                    </ThemedText>
                </View>
...
export default WorkspacesTutorialScreen;
